...
- Posso não saber de tudo porem possuo a disposição necessaria de pesquisar e te entregar.
...
- Atendimento ao público virtualmente e por meio físico, check in de documentos, aprovação dos mesmos, inspeção de documentos clinicos e organização física.
